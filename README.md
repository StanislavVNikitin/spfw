...
- **MVC‑структура**: разделение на контроллеры (`app/Controllers`), модели (`app/Models` и собственные модели), представления (`app/Views`).
- **Шаблоны**: поддержка собственных шаблонов и Twig.
